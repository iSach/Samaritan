...
public enum Commands {
    ...
    BRAINFUCK(CommandBrainFuck.class, 0, "Runs BrainFuck", "brainfuck", "bf"),
    BEAM(CommandBeam.class, 2, "Beam Commands", "beam"),
    CLEAN(CommandClean.class, 3, "Cleans fail", "clean"),
    ...
    GITHUB(CommandGithub.class, 0, "Github link", "git", "github"),
    GROUP(CommandGroup.class, 0, "Group Things", "group", "g"),
    HASTE(CommandHaste.class, 0, "Hastebin Code.", "haste"),
    ...
    SEND(CommandSend.class, 2, "Sends WS Msg.", "send", "socket"),
    ...
    TIC_TAC_TOE(CommandTicTacToe.class, 0, "Tic Tac Toe Game", "tictactoe", "ttt"),
    ...
    URBAN(CommandUrban.class, 0, "Urban Def.", "urban", "def", "ud"),
